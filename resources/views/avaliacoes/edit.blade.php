    ...
    <div class="py-4 bg-pink-100 min-h-screen">
        <div class="max-w-md mx-auto px-4">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                <h1 class="text-2xl font-bold text-pink-800 mb-5">Editar Avaliação</h1>
                ...
                <form action="{{ route('avaliacoes.update', $avaliacao->id) }}" method="POST" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        <input type="text" name="usuario" id="usuario" 
                               value="{{ old('usuario', $avaliacao->usuario) }}" required
                    ...
                    <div>
                        <label for="comentario" class="block font-medium text-pink-800 mb-1">Comentário:</label>
                        <textarea name="comentario" id="comentario" rows="4" required
                                  class="w-full border-gray-300 rounded-md focus:border-orange-500 focus:ring-orange-500">{{ old('comentario', $avaliacao->comentario) }}</textarea>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-3">
                        ...
                        <button type="submit" 
                                class="px-4 py-2 bg-orange-500 rounded-lg font-bold text-white hover:bg-orange-600 shadow-md">
                            Atualizar Avaliação
                        </button>
                    </div>
                </form>
