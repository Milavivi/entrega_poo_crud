    ...
    <div class="py-4 bg-pink-100 min-h-screen">
        <div class="max-w-md mx-auto px-4">
            <div class="bg-white p-6 rounded-lg shadow-lg">
                ...
                <h1 class="text-2xl font-bold text-pink-800 mb-5">Adicionar Ingrediente</h1>
                ...
                <form action="{{ route('ingredientes.store') }}" method="POST" class="space-y-4">
                    @csrf
                    <div>
                    ...
                    <div class="flex space-x-4">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="text" name="unidade" id="unidade" value="{{ old('unidade') }}" required
                                   class="w-full border-gray-300 rounded-md focus:border-orange-500 focus:ring-orange-500">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="receita_id" id="receita_id" required
                            ...
                            <option value="{{ $rec->id }}" {{ old('receita_id') == $rec->id ? 'selected' : '' }}>
                                {{ $rec->titulo }}
                            </option>
                            @endforeach
                        </select>
