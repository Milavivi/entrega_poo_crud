<x-app-layout>
    ...
    <!-- Estrutura Principal e Fundo Suave -->
    <div class="py-6 bg-pink-100 min-h-screen">
        <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">

            <div class="bg-white p-6 rounded-xl shadow-lg">

                <h1 class="text-3xl font-bold text-pink-800 mb-6">Criar Receita</h1>
                ...
                <form action="{{ route('receitas.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="number" name="tempo_preparo" id="tempo_preparo" value="{{ old('tempo_preparo') }}" required
                               class="w-full border-gray-300 rounded-md focus:border-orange-500 focus:ring-orange-500">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="descricao" id="descricao" rows="3" required
                                  class="w-full border-gray-300 rounded-md focus:border-orange-500 focus:ring-orange-500">{{ old('descricao') }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="modo_preparo" id="modo_preparo" rows="5" required
                                  class="w-full border-gray-300 rounded-md focus:border-orange-500 focus:ring-orange-500">{{ old('modo_preparo') }}</textarea>
                    </div>
                    ...
                    <div class="flex justify-between items-center pt-4">
                        ...
                        <button type="submit" 
                                class="px-5 py-2 bg-pink-800 rounded-lg font-bold text-lg text-white hover:bg-pink-900 shadow-md transition">
                            Criar
                        </button>
                    </div>
                </form>
